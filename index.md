...
ease  * [official-keyframes](#mixin-keyframes-official)
...
Example: {% highlight scss %}@include animation-name( 'fadeIn' );{% endhighlight %}
...
Example: {% highlight scss %}@include animation-duration( 2s );{% endhighlight %}
...
Example: {% highlight scss %}@include animation-timing-function( ease-in );{% endhighlight %}
...
Example: {% highlight scss %}@include animation-fill-mode( both );{% endhighlight %}
...
Example: {% highlight scss %}@include animation-iteration-count( 3 );{% endhighlight %}
...
Example: {% highlight scss %}@include animation-direction( reverse );{% endhighlight %}
...
Example: {% highlight scss %}@include animation-play-state( paused );{% endhighlight %}
...
Example: {% highlight scss %}@include animation-delay( 2s );{% endhighlight %}
